...
?>
  ...
  <h1>Silvergreen Sign-up Form </h1><p>Please use this form if you would like to join the
  Silvergreen interest group.&nbsp; You will receive news about how the ecovillage is progressing,
  and invitations to meetings.&nbsp; Your email address will not be used for any other purpose, I
  promise! </p><p>&nbsp;</p>
  <form name="form1" id="form1" method="post" action="SignupFormSubmit.php">
    <table border="0" cellspacing="0" cellpadding="5">
      <tr>
        <th width="150" align="right"><span class='reqdField'>*</span> <label
            for="name">Name:</label>
        </th>
        <td width="250"><input type="text" name="name" id="name" style="width:250px"></td>
      </tr>
      <tr>
        <th align="right"><span class='reqdField'>*</span> <label for="email_address">Email
            address:</label></th>
